...
```{r}
read_mice_behavior_remove_outliers <- function(file_path, fps, 
                                               rm_z_outlier = F,
                                               z_threshold = 3,
                                               rm_cage_outlier = F,
...
```{r}
rm_none <- read_mice_behavior_remove_outliers(file.path("projects/iba1_bdnf/data", "0907-1-C2.csv"), fps = 20)
rm_cage <- read_mice_behavior_remove_outliers(file.path("projects/iba1_bdnf/data", "0907-1-C2.csv"), fps = 20, rm_cage_outlier = TRUE)
rm_out <- read_mice_behavior_remove_outliers(file.path("projects/iba1_bdnf/data", "0907-1-C2.csv"), fps = 20, rm_z_outlier = TRUE, rm_cage_outlier = TRUE)
```
